...
<body>
	...
	<div id="write_wrap">
		...
		<div class="content_title">
			<h1>습득물 등록</h1>
			<p>(<span>＊</span>) 표시는 필수입력 항목입니다.</p>
		</div>
		<div id="sub_wrap">
			<form action="${conPath }/findWrite.laf" method="post"
				...
				<div class="btn_wrap">
					<input type="submit" value="등록" class="btn"> <input
						...
						value="목록" class="btn"
						onclick="location.href='${conPath}/findList.laf?pageNum=1'">
				</div>
			</form>
		</div>
	</div>
