			...
			<form action="${conPath }/modify.laf" method="post">
				<table id="up_table">
					...
					<tr>
						...
						<td><input type="text" name="mName" class="mName" id="mName"
							value='${member.mName != null ? member.mName : "" }'></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" name="tempBirth" class="tempBirth"
							id="datepicker"
							value='${member.mBirth != null ? member.mBirth : ""}'></td>
					</tr>
					<tr>
						<th>연락처</th>
						<td><select name="mTel1" class="mTel1" id="mTel1">
							...
							value='${member.mTel2 != null ? member.mTel2 : ""}'> - <input
							type="text" name="mTel3" class="mTel3" maxlength="4"
							value='${member.mTel3 != null ? member.mTel3 : ""}'></td>
					</tr>
					<tr>
						<th>거주지</th>
					...
					<tr>
						...
						<td><input type="text" name="mEmailId" class="mEmailId"
							id="mEmailId"
							value='${member.mEmailId != null ? member.mEmailId : ""}'>
							@ <input type="text" name="mEmailDomain" class="mEmailDomain"
							id="mEmailDomain" disabled="disabled"
							value='${member.mEmailDomain != null ? member.mEmailDomain : ""}'>
							<select name="domainVal" class="domainVal" id="domainVal">
								<option value="">선택</option>
								<option
									${member.mEmailDomain == "naver.com" ? "selected=\"selected\"" : "" }>naver.com</option>
								<option
									${member.mEmailDomain == "daum.net" ? "selected=\"selected\"" : "" }>daum.net</option>
								<option
									${member.mEmailDomain == "hanmail.net" ? "selected=\"selected\"" : "" }>hanmail.net</option>
								<option
									${member.mEmailDomain == "nate.com" ? "selected=\"selected\"" : "" }>nate.com</option>
								<option
									${member.mEmailDomain == "gmail.com" ? "selected=\"selected\"" : "" }>gmail.com</option>
								<option
									${member.mEmailDomain == "hotmail.com" ? "selected=\"selected\"" : "" }>hotmail.com</option>
								<option>직접입력</option>
						</select></td>
					</tr>
				</table>
				<table id="down_table">
					...
					<tr>
						...
						<td><input type="text" name="mQuiz" class="mQuiz" list="quiz"
							placeholder="직접 입력 가능" value="${member.mQuiz }"> <datalist
								id="quiz">
					...
					<tr>
						<th>답변</th>
						<td><input type="text" name="mAnswer" class="mAnswer"
							value="${member.mAnswer }"></td>
					</tr>
				</table>
				<div class="btn_wrap">
					<input type="submit" value="정보수정" class="btn"> <input
						type="button" value="취소" class="btn" onclick="history.back()">
				</div>
			</form>
		</div>
	</div>
